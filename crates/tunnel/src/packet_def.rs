...
use zerocopy::{byteorder::*, FromBytes, FromZeros, Immutable, IntoBytes, KnownLayout};
...
#[repr(C, packed)]
#[derive(IntoBytes, FromBytes, Clone, Debug, Default, KnownLayout)]
...
#[repr(C, packed)]
#[derive(IntoBytes, FromBytes, Clone, Debug, Default, Immutable, KnownLayout)]
...
#[repr(C, packed)]
#[derive(IntoBytes, FromZeros, Clone, Debug, Default)]
